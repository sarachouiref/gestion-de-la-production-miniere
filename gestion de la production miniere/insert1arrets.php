...
$stmt = $conn->prepare("INSERT INTO arretssitea(id_arrets, nombre_d_arrets, Duree_total_des_arrets, Nvoyage, type_de_camion) VALUES(:id_arrets, :nombre_d_arrets, :Duree_total_des_arrets, :Nvoyage, :type_de_camion)");
