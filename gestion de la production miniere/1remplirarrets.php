...
$servername="localhost";
 ...
 $password="";
  ...
  ?>
             ...
             <form class="sign up-form" method="POST" action="insert1arrets.php">
 ...
 <table border="1" width="80%">
  ...
  $stmt=$conn->query("SELECT * FROM arretssitea");
  ...
  foreach ($data as $row) { ?>
    ...
    <tr>        
      ...
      <td><a href="supprimerArretsa.php?id_arrets=<?php echo($row['id_arrets'])?>">supprimer</td>
    </tr>
     <?php } ?>
