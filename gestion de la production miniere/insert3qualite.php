...
$stmt=$conn->prepare("INSERT INTO qualitesitec(id_qualite,date_d_extraction,Nvoyage,type_de_qualite,quantite)values(:id_qualite,:date_d_extraction,:Nvoyage,:type_de_qualite,:quantite)");
