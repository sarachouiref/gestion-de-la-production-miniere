...
try {
    ...
    $stmt = $conn->prepare("INSERT INTO voyagesitea (Nvoyage, Nconducteur, destination, distance, date_de_depart, heure_de_depart, date_d_arrivee, heure_d_arrivee) VALUES (:Nvoyage, :Nconducteur, :destination, :distance, :date_de_depart, :heure_de_depart, :date_d_arrivee, :heure_d_arrivee)");
