...
$servername="localhost";
 ...
 $password="";
  ...
  ?>
             ...
             <form class="sign up-form" method="POST" action="insert1qualite.php">
...
<script>
 ...
 <table border="1" width="80%">
  ...
  $stmt=$conn->query("SELECT * FROM qualitesitea");
  ...
  foreach ($data as $row) { ?>
    ...
    <tr> 
      ...
      <td><a href="supprimerQualitea.php?id_qualite=<?php echo($row['id_qualite'])?>">supprimer</td>
    </tr>
     <?php } ?>
